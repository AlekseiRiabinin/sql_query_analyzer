...
class ContainersResourceMonitor:
    ...
    def get_all_container_resources(self: Self) -> dict[str, Any]:
        ...
        try:
            app_stats = self.get_application_resources()
            postgres_stats = (
                self.get_postgres_container_resources()
            )
            
            return {
                "application_container": app_stats,
    ...
    def get_postgres_container_resources(
        ...
        """Get resource metrics for PostgreSQL using Docker API."""
        ...
        try:
            ...
            if system_delta > 0 and cpu_delta > 0:
                cpu_percent = (
                    ...
                    len(
                        cpu_stats['cpu_usage']['percpu_usage'] or 
                        [1]
                    ) * 100
                )
